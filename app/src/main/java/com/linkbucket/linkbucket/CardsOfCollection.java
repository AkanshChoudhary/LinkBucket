...
public class CardsOfCollection extends AppCompatActivity {
    ...
    public void selectDeselectCard(String cardNumber)
    {
        int position = 0;
        int i = 0;
                ...
                .addOnCompleteListener(task ->
                {
                    ...
                    for (QueryDocumentSnapshot doc2 : task.getResult()) {
                        if (cardList.contains(doc2.getId())) {
                            collectionCardList.add(new RecyclerItem(R.drawable.ic_plane, doc2.getString("card_name"), doc2.getString("card_desc"), doc2.getString("link"), CardsOfCollection.this,doc2.getString("cardNumber"),false,false));
