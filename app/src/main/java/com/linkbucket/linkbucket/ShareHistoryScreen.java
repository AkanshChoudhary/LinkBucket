...
public class ShareHistoryScreen extends AppCompatActivity {
    ...
    final List<HistoryItem> codeItems = new ArrayList<>();
    final List<HistoryItem> toAppItems = new ArrayList<>();
    RecyclerView historyRecyclerView;
    final String[] choices = {"Select History Type", "Code", "App to App"};
    TextView title;
                                        ...
                                        .addOnCompleteListener(task -> {
                                            for (QueryDocumentSnapshot dc : task.getResult()) {
                                                if (myCards.contains(dc.getId())) {
                                                    cardList.add(new RecyclerItem(R.drawable.ic_plane, dc.getString("card_name"), dc.getString("card_desc"), dc.getString("link"), ShareHistoryScreen.this, dc.getString("cardNumber"), false,false));
                                                }
                                            }
                                            ...
                                            .addOnCompleteListener(task1 -> {
                                                for (QueryDocumentSnapshot dc1 : task1.getResult()) {
                                                    if (list.contains(dc1.getId())) {
                                                        cardList1.add(new RecyclerItem(R.drawable.ic_plane, dc1.getString("card_name"), dc1.getString("card_desc"), dc1.getString("link"), ShareHistoryScreen.this, dc1.getString("cardNumber"), false,false));
                                                    }
                                                }
