    ...
    * */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseFirestore.collection("user+" + userId).document("allSavedThings").collection("cards")
                ...
                .addOnCompleteListener(task -> {
                    ...
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        cardNumber = (long) document.get("cardNumber");
                        itemList.add(new RecyclerItem(R.drawable.ic_plane, name, desc, link, MainUserDashboard.this, cardNumber, true));
                    ...
                    finalCardNumber = task.getResult().size();
        ...
        recyclerAdapter.setOnCardSelectedListener(cardNumber -> {
            ...
            Toast.makeText(this, String.valueOf(cardNumber), Toast.LENGTH_SHORT).show();
        });
    ...
    {    AlertDialog.Builder builder1 = new AlertDialog.Builder(MainUserDashboard.this, R.style.DialogTheme);
        ...
        message.setText("Hey! Welcome to LinkBucket.\nNow you can save , group , and share\n various different links together.");
        builder1.setView(v1);
    ...
    private void updateDetailOnFireStore(Item item, String detail, long cardNumber) {
        firebaseFirestore.collection("user+" + userId).document("allSavedThings").collection("cards").document("card " + cardNumber)
    ...
    public void newCard() {
        ...
        v2.findViewById(R.id.save_action).setOnClickListener(v -> {
            ...
            newCardMap.put("cardNumber", finalCardNumber + 1);
            newCardMap.put("upload_time", timestamp.getTime());
            firebaseFirestore.collection("user+" + userId).document("allSavedThings").collection("cards").document("card " + (finalCardNumber + 1))
                    .set(newCardMap)
                    .addOnSuccessListener(aVoid -> {
                        itemList.add(new RecyclerItem(R.drawable.ic_www, cardName.getText().toString(), cardDesc.getText().toString(), link.getText().toString(), MainUserDashboard.this, finalCardNumber + 1, true));
    ...
    public void selectDeselectCard(long cardNumber) {
        ...
        if (itemList.get(position).getState()) {
